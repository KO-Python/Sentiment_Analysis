...
if st.session_state["page"] == "intro":
    ...
    정답은 없으니, 평소 생각과 감정을 편하게 들려주세요. 
    응답해주신 내용은 연구에만 사용되며, 익명성은 철저히 지켜지니 안심하고 작성해주세요.''')
...
# ============================================
    ...
    st.write('''
    참여해주셔서 진심으로 감사드립니다. 귀하께서 작성해주신 내용은 20·30대 남성과 여성에 대한 감정을 알아보기 위해 제작하였습니다. 응답 내용은 오직 학술 연구 목적으로만 활용됩니다.
